    ...
    pub fn translate(&self, cds_start: usize) -> Result<String, HgvsError> {
        ...
        for i in (0..seq_slice.len()).step_by(3) {
            ...
            let res = match codon.to_uppercase().as_str() {
                ...
                "CCT" | "CCC" | "CCA" | "CCG" | "CCU" | "CCA" | "CCG" => 'P', // Removed duplication
                "ACT" | "ACC" | "ACA" | "ACG" | "ACU" | "ACC" | "ACA" | "ACG" => 'T',
                "GCT" | "GCC" | "GCA" | "GCG" | "GCU" | "GCC" | "GCA" | "GCG" => 'A',
                "TAT" | "TAC" | "UAU" | "UAC" => 'Y',
                ...
                "TGT" | "TGC" | "UGU" | "UGC" => 'C', 
                "TGG" | "UGG" => 'W',
                "CGT" | "CGC" | "CGA" | "CGG" | "CGU" | "CGC" | "CGA" | "CGG" | "AGA" | "AGG" => 'R',
                "GGT" | "GGC" | "GGA" | "GGG" | "GGU" | "GGC" | "GGA" | "GGG" => 'G',
                 _ => 'X',
            };
            aa.push(res);
            if res == '*' { break; }
